...
class Admin extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('judul', 'Judul', 'required', 'required|min_length[8]|max_length[20]|regex_match[/^(?=.*[0-9])(?=.*[a-zA-Z])([a-zA-Z0-9]+)/s]',[
          'regex_match' => 'Masukkan 8-20 karakter untuk judul'
        ]);
